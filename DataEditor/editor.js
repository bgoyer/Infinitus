...
let currentShipData = {
    hardpoints: [],
    sprite: null, // Base64 encoded sprite data
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateTypeSpecificFields() {
        ...
        // Add hardpoint editor for ships
        if (currentType === 'ship') {
            createHardpointEditor();
        } else {
            // Hide hardpoints tab for other component types
    ...
    function createHardpointEditor() {
        hardpointsTabContent.innerHTML = '';
        
        const container = document.createElement('div');
        container.className = 'hardpoint-editor';
        hardpointsTabContent.appendChild(container);
        ...
        container.appendChild(hardpointTableContainer);
    ...
    function saveComponent() {
        ...
        if (currentType === 'ship') {
            ...
            if (currentShipData.sprite) {
                data.sprite = currentShipData.sprite;
            }
            
            // Add hardpoints if available
            if (currentShipData.hardpoints && currentShipData.hardpoints.length > 0) {
                data.hardpoints = [...currentShipData.hardpoints];
            }
